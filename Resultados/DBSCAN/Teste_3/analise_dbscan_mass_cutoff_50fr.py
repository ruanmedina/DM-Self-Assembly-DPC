...
for dm_file_name in dm_names:
    ...
    for chunk in md.iterload('./../../'+dm_file_name.split('.')[0]+'.dcd', chunk=10, top='./../../imaged'+'.pdb'):
        ...
        db = cluster.DBSCAN(eps=0.16, min_samples=2, algorithm='kd_tree', metric='euclidean').fit(X)
...
#        
#        plt.savefig("graf_disp_ct_distmin0.14_smll2/plot_"+str(FRAME)+".png")
#        plt.close()
#        #plt.show()
...
Data_analysis.to_csv("graf_disp_ct_distmin0.16_smll2/data_analysis.csv")
