...
for dm_file_name in dm_names:
    ...
    for chunk in md.iterload('./../../'+dm_file_name.split('.')[0]+'.dcd', chunk=10, top='./../../imaged'+'.pdb'):
        ...
        db = cluster.DBSCAN(eps=0.14, min_samples=2, algorithm='kd_tree', metric='euclidean').fit(X)
...
Data_analysis.to_csv("graf_disp_ct_distmin0.14_smll2/data_analysis.csv")
